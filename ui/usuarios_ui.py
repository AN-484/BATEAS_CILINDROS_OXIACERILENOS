...
class UsuariosUI(QWidget):
    def __init__(self):
        ...
        self.table.setHorizontalHeaderLabels(["Código", "Nombre", "Cargo"])
    ...
    def cargar(self):
        ...
        for i, d in enumerate(datos):
            ...
            self.table.setItem(i, 2, QTableWidgetItem(d.cargo))
    ...
    def eliminar(self):
        ...
        db = SessionLocal()
        obj = db.query(Usuario).filter_by(codigo=codigo).first()
